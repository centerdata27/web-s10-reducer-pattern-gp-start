...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case TOGGLE_SHOW_COMPLETE_TODOS:
      return {
        ...state,
        toggleShowCompleteTodo: !state.toggleShowCompleteTodo
      }
  ...
  return (
    <div id="mp">
      ...
      <Todos
        ...
        showCompletedTodos={state.toggleShowCompleteTodo}
        toggleShowCompleteTodo={toggleShowCompleteTodo}
      />
      <TodoForm
